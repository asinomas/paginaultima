    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          {/* RIGHT COLUMN - Models + Cards */}
          <div className="flex flex-col">
            {/* Collaboration Models Section */}
            <div className="mb-12">
              <h4 className="text-[10px] font-bold tracking-[0.4em] text-slate-400 uppercase mb-4 border-b border-slate-200 pb-2">
              ...
              <div className="flex flex-nowrap gap-4 xl:gap-6">
                {collaborationModels.map((model, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm xl:text-base font-normal tracking-tight text-slate-700 group-hover:text-[#135bec] transition-colors duration-300 whitespace-nowrap">
                      {model}
                    </span>
                  </div>
                ))}
