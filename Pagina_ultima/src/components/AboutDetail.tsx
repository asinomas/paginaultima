...
import TextLoop from './TextLoop'; // tu loop de texto
...
const AboutDetail: React.FC<AboutDetailProps> = ({ onContactClick, onNavigate }) => {
  ...
  // --- Visibilidad del título para activar el loop ---
  ...
  const team = [
    { name: 'Rodrigo Ledesma', role: 'CEO & Founder', image: './team/rodrigo.jpg', bio: 'Experto en sistemas y gestión operativa escalable...', linkedin: 'https://linkedin.com/in/rodrigo-andres-ledesma-ritchie-6370aa26' },
    { name: 'Cristian Quezada', role: 'IT Architect', image: './team/cristian.jpg', bio: 'Estratega de TI con foco en diseñar arquitecturas eficientes...', linkedin: 'https://linkedin.com/in/cristian-quezada-00372920' },
    { name: 'Byron Molina', role: 'Backend Developer', image: './team/byron.jpg', bio: 'Especialista en desarrollo, despliegue y mantención de aplicaciones...', linkedin: 'https://linkedin.com/in/bmolinh' },
    { name: 'Daniela Paredes', role: 'Project Management Office', image: './team/daniela.jpg', bio: 'Líder en planificación, gestión y supervisión organizacional...', linkedin: 'https://linkedin.com/in/daniela-paredes-vidal' },
    { name: 'Gonzalo Astudillo', role: 'IT Delivery Manager', image: './team/gonzalo.jpg', bio: 'Impulsor de innovación tecnológica y proyectos críticos...', linkedin: 'https://linkedin.com/in/gastu' }
  ];
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-slate-500 mb-6 leading-relaxed tracking-tighter">
                Nacimos para transformar la complejidad técnica en valor empresarial...
              </p>
                        ...
                        <div className={`absolute inset-0 flex flex-col p-6 transition-all duration-700 ${expandedCard === i ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                          <div className="flex items-start gap-4 mb-6">
                            <div className="flex-shrink-0 w-16 h-16 rounded-full overflow-hidden">
                              <img src={member.image} alt={member.name} className="w-full h-full object-cover grayscale" onError={(e) => {(e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=800';}} />
                            </div>
