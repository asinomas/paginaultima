...
const AboutDetail: React.FC<AboutDetailProps> = ({ onContactClick, onNavigate }) => {
  ...
  return (
    <div className="bg-white min-h-screen antialiased">
      ...
      <section className="relative bg-[#F8FAFC] pt-24 pb-12 after:absolute after:bottom-0 after:left-0 after:w-full after:h-48 after:bg-gradient-to-b after:from-[#F8FAFC]/20 after:via-[#F8FAFC]/60 after:to-white after:pointer-events-none">
      ...
      <section className="container mx-auto max-w-7xl px-6 lg:px-8 py-24">
        <div className="text-center mb-24 flex flex-col items-center">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto text-lg leading-relaxed font-medium">
            Nuestro equipo está compuesto por personas con un buen mindset, apasionados por la tecnología que dirigen el rumbo de cada proyecto con rigor y visión.
          </p>
        </div>
