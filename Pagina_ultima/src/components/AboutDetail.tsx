...
const AboutDetail: React.FC<AboutDetailProps> = ({ onContactClick, onNavigate }) => {
  ...
  return (
    <div className="bg-white min-h-screen antialiased">
      ...
      <section className="relative bg-[#F8FAFC] pt-30 pb-24 after:absolute after:bottom-0 after:left-0 after:w-full after:h-48 after:bg-gradient-to-b after:from-[#F8FAFC]/20 after:via-[#F8FAFC]/60 after:to-white after:pointer-events-none">
