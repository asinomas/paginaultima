        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-lg lg:text-xl text-slate-500 leading-relaxed mb-10 max-w-xl">
              Nacimos para estructurar la complejidad técnica en valor empresarial. Somos un equipo de alto impacto, obsesión por el detalle y mentalidad problem-solver.
            </p>
