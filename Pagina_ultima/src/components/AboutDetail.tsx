  ...
  const team = [
    {
      ...
      bio: 'Experto en arquitectura de sistemas y gestión operativa, especializado en garantizar la continuidad de negocios.',
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-lg lg:text-xl text-slate-500 leading-relaxed mb-10 max-w-xl">
              Nacimos con la visión de cerrar la brecha entre la complejidad técnica y el éxito empresarial. Somos un equipo de impacto, obsesión por el detalle y mentalidad problem-solver.
            </p>
        ...
        <div className="container mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">
              Talento sin fronteras, soporte sin interrupciones.                   Nuestro equipo se encuentra en las siguientes ubicaciones
            </h2>
