    ...
    <div className="bg-white min-h-screen pt-24 antialiased">
      ...
      <section className="container mx-auto max-w-7xl px-6 lg:px-8 mb-32">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 flex justify-center relative">
            ...
            {/* IMAGEN LIBRE, ESCALADA, TRADUCIDA, SOMBRA VISIBLE */}
            <div className="relative hidden md:flex">
              <div className="shadow-2xl rounded-3xl scale-[1.4] -translate-y-1 -translate-x-5">
                <img 
                  src={fotoAbout} 
                  alt="Team Work" 
                  className="w-full max-w-md object-contain scale-[1.4] -translate-y-1 -translate-x-5" 
                  onError={(e) => {
      ...
      <section className="container mx-auto max-w-7xl px-6 lg:px-8 mb-40">
        <div className="text-center mb-24">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto text-lg leading-relaxed font-medium">Líderes apasionados por la tecnología que dirigen el rumbo de cada proyecto con rigor y visión.</p>
        </div>
