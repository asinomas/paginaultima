  ...
  return (
    <div className="group relative bg-white p-12 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col">
        ...
        {/* Contenido del acordeón con slide + fade */}
        <div
          ref={contentRef}
          style={{ maxHeight: isOpen ? height : 0 }}
          className={`overflow-hidden transition-all duration-500 transform-gpu ${
            isOpen ? 'opacity-100 scale-y-100 mt-4' : 'opacity-0 scale-y-95 mt-0'
          }`}
        >
          <ul className="pl-4 list-disc text-slate-500 text-sm space-y-1">
