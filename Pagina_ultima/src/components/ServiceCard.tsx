const ServiceCard: React.FC<ServiceCardProps> = ({ specialty }) => {
  ...
  return (
    <div ref={cardRef} className="group relative bg-white rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden flex flex-col">
      ...
      <div className="p-12">
        ...
        <div className="relative z-10">
          ...
          {/* Botón con TU animación de flecha */}
          <button 
      ...
      {/* Acordeón con MI fondo gris completo */}
      <div 
        className={`overflow-hidden transition-all duration-500 ${
          isOpen ? 'max-h-96' : 'max-h-0'
        }`}
      >
        <div className="bg-slate-50 border-t border-slate-100 px-12 py-6">
