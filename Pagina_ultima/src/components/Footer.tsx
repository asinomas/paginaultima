      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12 items-start">
          ...
          <div className="md:col-span-3 lg:col-span-3 mt-6 md:mt-0">
            ...
            {/* Opciones de contacto alternativas - AJUSTADO A TAMAÑO Y COLORES DEL FOOTER */}
            <div className="flex flex-wrap items-center justify-center gap-4 mt-4">
              <span className="text-sm text-slate-400">o contacta directamente:</span>
              <a 
                href="https://wa.me/56944030716" 
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 bg-green-500 text-white text-sm rounded-lg hover:bg-green-600 transition-all shadow-md hover:shadow-lg"
              ...
              <a 
                href="tel:+56944030716"
                className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white text-sm rounded-lg hover:bg-blue-600 transition-all shadow-md hover:shadow-lg"
