      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12 items-start">
          ...
          <div className="col-span-1 md:col-span-6 lg:col-span-5 flex flex-col items-start">
            ...
            <p className="text-[12px] sm:text-[13px] md:text-[14px] font-light text-slate-400 max-w-sm leading-relaxed tracking-tight">
          ...
          <div className="md:col-span-3 lg:col-span-3 lg:ml-auto mt-6 md:mt-0">
            <h5
              className="mb-4 md:mb-6 text-[11px] sm:text-[12px] md:text-[13px] font-light uppercase tracking-widest"
              style={{ color: '#135bec' }}
            >
              Capacidades
            </h5>
            <ul className="space-y-2 md:space-y-4 text-[12px] sm:text-[13px] md:text-[14px] font-light text-slate-300">
        ...
        <div className="mt-12 md:mt-16 border-t border-white/10 pt-6 md:pt-8 text-center md:flex md:justify-between md:text-left">
          <p className="text-[12px] sm:text-[13px] md:text-[14px] font-light text-slate-500">
            © {new Date().getFullYear()} BlackTI. Todos los derechos reservados.
          </p>
          <div className="mt-4 md:mt-0 flex justify-center gap-4 md:gap-6">
            <a className="text-[12px] sm:text-[13px] md:text-[14px] font-light text-slate-500 hover:text-white transition-colors" href="#">Privacidad</a>
            <a className="text-[12px] sm:text-[13px] md:text-[14px] font-light text-slate-500 hover:text-white transition-colors" href="#">Términos</a>
          </div>
        </div>
      </div>
    </footer>
