    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#0b0e14] overflow-hidden pt-20 antialiased">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-12">
          <div className={`max-w-4xl text-center transition-all duration-[3s] ${showImage ? '-translate-x-64' : 'translate-x-0'}`}>
          ...
          <div 
            className={`absolute right-0 w-[500px] h-[500px] bg-red-500 flex-shrink-0 transition-all duration-3000 ${
