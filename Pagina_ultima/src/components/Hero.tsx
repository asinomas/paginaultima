  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#0b0e14] overflow-hidden pt-20 antialiased">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#135bec]/20 rounded-full blur-[120px] animate-[pulse_6s_infinite]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[45%] h-[45%] bg-blue-600/10 rounded-full blur-[100px] animate-[pulse_10s_infinite_reverse] opacity-70"></div>
        <div className="absolute top-[-5%] right-[-10%] w-[40%] h-[40%] bg-[#135bec]/15 rounded-full blur-[110px] animate-[pulse_18s_infinite_2s]"></div>
        <div className="absolute bottom-[-5%] right-[-5%] w-[35%] h-[35%] bg-blue-500/10 rounded-full blur-[90px] animate-[pulse_5s_infinite_1s]"></div>
