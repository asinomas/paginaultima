...
const Logos: React.FC = () => {
  const logos = [
    ...
    { name: 'Casa&Ideas', src: 'https://static.wikia.nocookie.net/logopedia/images/0/01/Casaideas_logo.png' },
    { name: 'Globant', src: 'https://upload.wikimedia.org/wikipedia/commons/5/56/Globant-LightBG-Color%403x.png' },
    { name: 'Marubeni', src: 'https://companieslogo.com/img/orig/8002.T_BIG-8c9cf180.png' },
